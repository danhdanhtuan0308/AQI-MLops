...
Infrastructure-as-code for running the AQI API on an AWS EC2 t4g.small (ARM64 Graviton, Ubuntu 24.04). The service runs inside Docker, managed by a systemd unit that wraps `docker compose`.
